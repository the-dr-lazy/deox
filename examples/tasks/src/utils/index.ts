...
export const ofType = <
    ...
    O extends AnyAction = AC extends ActionCreator<infer T> ? (T extends AnyAction ? T : never) : never
>(
    actionCreator: AC,
): ((source: Observable<I>) => Observable<O>) => _ofType(getType(actionCreator)) as any
