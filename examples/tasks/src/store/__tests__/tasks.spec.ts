import { addTask, editTask, getAllTasks, removeFinishedTasks, removeTask, tasks } from '../tasks'
...
describe('tasks', () => {
    ...
    describe('reducer', () => {
        ...
        it.each([{ title: 'New title for task' }, { description: 'New description for task' }, { isFinished: true }])(
            'should handle "[Tasks] edit"',
            update => {
                const id = 'x'
                const state = {
                    byId: {
