...
export type CategoryItemInnerProps = CategoryItemInnerDispatchProps & CategoryItemInnerOwnProps

export const CategoryItemInner = ({ color, label, value, active, className, createSnackbar }: CategoryItemInnerProps) => (
    <li
    ...
    >
        <CategoryIndicator className="CategoryItem__indicator" color={color} active={active} />
...
export const CategoryItem = connect<null, CategoryItemInnerDispatchProps, CategoryItemInnerOwnProps>(null, { createSnackbar })(
    CategoryItemInner,
)
