...
const createIcon = ({ width = '32px', height = '32px', viewBox = '0 0 32 32', d }: CreaeIconProps) => (props: JSX.IntrinsicElements['svg']) => (
    <svg {...props} width={width} height={height} viewBox={viewBox} version="1.1" xmlns="http://www.w3.org/2000/svg">
